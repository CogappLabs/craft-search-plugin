...
const copyTargets: Record<string, string> = {
	"histogram/dist/histogram.js": resolve(
		__dirname,
		"src/templates/stubs/sprig/js/histogram.js",
	),
};
...
export default defineConfig({
	...
	build: {
		...
		rollupOptions: {
			input: {
				"indexedit/dist/index-edit": resolve(
					assetsDir,
					"indexedit/src/index-edit.ts",
				),
				"indexlist/dist/index-list": resolve(
					assetsDir,
					"indexlist/src/index-list.ts",
				),
				...
				"searchpage/dist/search-page": resolve(
					assetsDir,
					"searchpage/src/search-page.ts",
				),
				"histogram/dist/histogram": resolve(
					assetsDir,
					"histogram/src/histogram.ts",
				),
			},
			output: {
